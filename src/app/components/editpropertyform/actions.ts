...
import { Property, deleteProperty, updateProperty } from "@/db/homeseeker/property";
...
export async function updatePropertyDetails(id: number, updatedDetails: Partial<Property>): Promise<boolean | string> {
    try {
